...
class AudioPlayerOne extends StatefulWidget {
  @override
  _AudioPlayerOneState createState() => _AudioPlayerOneState();
}

class _AudioPlayerOneState extends State<AudioPlayerOne> {
  ...
  final list = [
    {
      ...
      "url": "assets/audio/xv.mp3",
      "coverUrl": "assets/audio/ic_launcher.png"
    },
    {
      "title": "network",
  ...
  void loadFile() async {
    ...
    final file = File("${appDocDir.path}/audio/aLIEz.m4a");
    file.writeAsBytesSync(audio);

    AudioInfo info = AudioInfo("file://${file.path}",
        title: "file", desc: "local file", coverUrl: "assets/audio/aLIEz.jpg");
